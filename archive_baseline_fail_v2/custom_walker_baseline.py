...
class CustomWalkerWrapper(gym.Wrapper):
    ...
    def step(self, action: int) -> Tuple[np.ndarray, float, bool, bool, dict]:
        ...
        # [Baseline - Original Reward Only]
        # ==================================================================
        # 이 버전은 BipedalWalker-v3의 원본 보상 함수를 그대로 사용합니다.
        # 어떠한 수정도 가하지 않은 "기준선(Baseline)"으로,
        # 추후 보상 함수 수정 버전과 성능을 비교하기 위한 대조군입니다.
        #
        # 원본 보상 함수 구성:
        #   - 전진 거리에 비례하는 양의 보상
        #   - 모터(토크) 사용량에 대한 작은 페널티
        #   - 넘어지면 -100점 페널티
        #   - 목표 지점 도달 시 추가 보상
        # ==================================================================
        
        # 에너지 추적 (분석용, 보상에는 반영 안 함)
        ...
        # 원본 보상 그대로 반환
        return reduced_obs, original_reward, terminated, truncated, info
